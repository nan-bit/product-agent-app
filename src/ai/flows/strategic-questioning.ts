...
const StrategicQuestioningInputSchema = z.object({
  ...
  pddDocument: z.string().describe('The current draft of the Privacy Design Document.'),
...
Analyze the current PRD, EDD, UXD, PDD and the conversation history. Compare them against the master schema to identify which topics are sparse or have not been discussed yet.
